...
import com.droidboys.goodtrips.Pojo.UserPass;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            String url = "http://goodtrips.herokuapp.com/api-token-auth/";
            String userPass="{\"username\":\""+email+"\","+"\"password\":\""+password+"\"}";
            JSONObject mObj=null;
            try {
                mObj=new JSONObject(userPass);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            JsonObjectRequest req=new JsonObjectRequest(Request.Method.POST, url, mObj, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {
                    if(response.length()==0){
                        ...
                        try {
                            ...
                            PrefsManager.setLoggedIn(true,getBaseContext());
                            PrefsManager.setLoginAuth(auth,getBaseContext());
                            finish();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
